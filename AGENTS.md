...
- The catalog may contain at most 40 Research Skills. Adding one at the cap
  requires an explicit cap decision or a simultaneous merge or retirement.
...
- paper-finish-loop: Build, finish, or check one paper package (file: workflow/skills/paper-writing/paper-finish-loop/SKILL.md)
